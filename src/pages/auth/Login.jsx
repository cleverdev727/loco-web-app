const Login = () => {
    return <>
        <div className="flex h-screen">
            <div className="w-5/12 h-full bg-maindark bg-auth-aside bg-cover px-10 relative">
            ...
            <div className="w-7/12 px-10 flex items-center relative">
                <div className="lg:mx-32">
                    <h1 className="text-2xl py-3 font-semibold">Welcome back!</h1>
                    <p className="text-sm mb-12">Log in to get started.</p>
                ...
                <div className="absolute bottom-10 right-20 text-[12.6px]">
                    <div>Don't have an account? <a href="#" className="text-yellow-300">Get started</a></div>
                </div>
            </div>
        </div>
    </>
